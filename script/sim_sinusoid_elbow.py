...
runCommandClient("robot.traj_gen.startSinusoid('le',-1.6,3.0)")
...
runCommandClient("robot.com_traj_gen.move(1,-0.06, 3.0)")

input("Waiting before starting sinusoid")
print("Start sinusoid")
runCommandClient("robot.com_traj_gen.startSinusoid(1,0.06,3.0)")
