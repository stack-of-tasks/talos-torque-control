...
from dynamic_graph.sot.torque_control.talos.create_entities_utils_talos_sinusoid import create_trajectory_switch, connect_synchronous_trajectories, create_force_traj_gen
from dynamic_graph.sot.torque_control.talos.create_entities_utils_talos_sinusoid import create_trajectory_generator, create_com_traj_gen, create_encoders, create_encoders_velocity
from dynamic_graph.sot.torque_control.talos.create_entities_utils_talos_sinusoid import create_imu_offset_compensation, create_filters, create_imu_filter
from dynamic_graph.sot.torque_control.talos.create_entities_utils_talos_sinusoid import create_base_estimator, create_position_controller, create_torque_controller
...
def main_sim_v3(robot, startSoT=True, go_half_sitting=True):
    conf = get_sim_conf();
    dt = robot.timeStep;
