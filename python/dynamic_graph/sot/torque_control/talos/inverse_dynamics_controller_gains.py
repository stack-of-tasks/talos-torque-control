...
k_s  = zeros(NJ);   # joint proportional gains (used by InverseDynamicsController)
k_d  = zeros(NJ);   # joint derivative gains  (used by InverseDynamicsController)
k_f  = zeros(6*4);  # force proportional gains  (used by InverseDynamicsController)
k_i  = zeros(6*4);  # force integral gains  (used by InverseDynamicsController)
