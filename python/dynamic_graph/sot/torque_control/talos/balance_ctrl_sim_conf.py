...
# CONTROLLER GAINS
NJ = 32;
# kp_posture  = (10., 5., 5., 1., 1., 10., 10., 5., 5., 1., 1., 10., 0., 0., 50., 10., 10., 10., 10., 10., 10., 10., 50., 10., 10., 10., 10., 10., 10., 10., 100., 100.)  # proportional gain of postural task
...
# kp_contact  = 1.0;   # constraint proportional feedback gain
# kd_contact  = 2*sqrt(kp_constr);   # constraint derivative feedback gain
# kp_com      = 20.0;
...
# RF_FORCE_DES = (0, 0, 400, 0, 0, 0.);
# LF_FORCE_DES = (0, 0, 400, 0, 0, 0.);